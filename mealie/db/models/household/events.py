...
class GroupEventNotifierOptionsModel(SqlAlchemyBase, BaseMixins):
    ...
    mealplan_attendance_reminder: Mapped[bool] = mapped_column(Boolean, default=False, nullable=False)
    mealplan_attendance_closed: Mapped[bool] = mapped_column(Boolean, default=False, nullable=False)
